...
function Imagegallery() {
  return (
    <div className='container my-5'>
        <h2 className='my-5 section-header'>
          <span className="badge rounded-pill bg-primary border"><img className="m-3" src={canva} alt="canva logo" width="70px" height="70px"/>Canva</span></h2>
        <div className="row row-cols-1 row-cols-md-3 g-4 bg-primary p-3 my-5">
  <div className="col">
    <div className="card">
